...
import {
  PartyButton,
  WatchPartyLayer,
} from "@/components/player/party/WatchPartyLayer";
...
export function PlayerPart(props: PlayerPartProps) {
  ...
  return (
    <Player.Container onLoad={props.onLoad} showingControls={showTargets}>
      ...
      <Player.TopControls show={showTargets}>
        <div className="grid grid-cols-[1fr,auto] xl:grid-cols-3 items-center">
          ...
          <div className="hidden sm:flex items-center justify-end gap-2">
            {status === playerStatus.PLAYING ? <PartyButton /> : null}
            <BrandPill />
          </div>
      ...
      <Player.CaptionAutoLoad />
      <Player.SkipSegment controlsShown={showTargets} />
      <Player.PlaybackNotice controlsShown={showTargets} />
