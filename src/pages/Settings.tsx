...
import { FluxAccountPart } from "@/pages/parts/settings/FluxAccountPart";
import { SidebarPart } from "@/pages/parts/settings/SidebarPart";
import { SourcesPart } from "@/pages/parts/settings/SourcesPart";
  ...
  return (
    <SubPageLayout>
      ...
      <SettingsLayout>
        ...
        <div id="settings-sources" className="mt-48">
          <SourcesPart
